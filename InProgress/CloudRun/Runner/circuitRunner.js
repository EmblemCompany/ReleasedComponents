...
// MIT License
// Copyright 2017 Peter Širka <petersirka@gmail.com>
...
Object.prototype.findComponentsByName = function(name) {
	return this.filter(comp=>{return comp.component === name})
}
Object.prototype.findComponentsById = function(id) {
	return this.filter(comp=>{return comp.id === id})
}