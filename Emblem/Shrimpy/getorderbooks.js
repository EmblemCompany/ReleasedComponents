...
exports.html = `<div class="padding">
    ...
    <div class="row">
        <div class="col-md-3">
            <div data-jc="textbox" data-jc-path="baseSymbol" data-jc-config="placeholder:xlm;required:true">@(Base Symbol) </div>
        </div>
        <div class="col-md-3">
            <div data-jc="textbox" data-jc-path="quoteSymbol" data-jc-config="placeholder:btc;required:true">@(Quote Symbol) </div>
        </div>
        <div class="col-md-3">
