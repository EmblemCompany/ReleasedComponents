# CircuitBuilder Components

This repository contains all __CircuitBuilder components__.

__Requirements for developing components__:
...
- keep readme 1:1 with readme in the component declaration
  // TODO Sync these two. This is dirty.
...
exports.install = function(component) {
	...
	component.on('data', function(message) {
		...
		// {Object} Parent component (first component which started the circuit)
		message.parent;
...
The below jComponents can be used in a component's`Settings form`:
